  ...
  <q-scroll-area :thumb-style="{width: '5px'}" class="contacts__list">
    <div class="q-px-lg q-py-md">
      ...
      <template v-if="group.isOrganization">
        ...
        <ContactInfoField :value="group.company" :caption="$t('CONTACTSWEBCLIENT.LABEL_COMPANY')" />
        ...
        <ContactInfoField :value="group.city" :caption="$t('CONTACTSWEBCLIENT.LABEL_CITY')" />
